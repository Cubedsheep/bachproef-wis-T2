...
Because the ideal MHD equations are in fact dimensionless (whitout th presence of sources and sinks), we can carry out the simulations in dimensionless units. 
