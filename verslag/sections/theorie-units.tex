...
Because the ideal MHD equations are in fact dimensionless (without sources) \todo{sources = bronnen of sources = - sinks}, we can carry out the simulations in dimensionless units. Later, we can scale our results to match conditions as found in e.g. the solar corona, requiring that the relative magnitudes of $\rho_0$, $v_0$ and $L_0$ are correct.
