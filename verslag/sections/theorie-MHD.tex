...
The MHD equations can then be found by adding the maxwell equations to the HD equations. There is one complication: the HD equations are invariant under Galilean transformations. 
...
To solve this the term for the displacement current $\epsilon_0 \frac{\partial \vec{E}}{\partial t}$ is dropped \improvement{referentie} which results in a set of equations that are invariant under Galilean transformations.
